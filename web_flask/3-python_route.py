...
(0.0.0.0) on port 5000. It has four routes:
- /: Displays "Hello HBNB!"
- /hbnb: Displays "HBNB"
- /c/<text>: Displays "C " followed by the value of the text variable, with underscores replaced by spaces
- /python/<text>: Displays "Python " followed by the value of the text variable, with underscores replaced by spaces
  - The default value for <text> is "is cool" if no text is provided
...
5. Open your web browser and go to:
   ...
   - `http://0.0.0.0:5000/python/<text>` for "Python <text>"
...
def python_text(text):
    ...
    Returns:
        str: A message "Python " followed by the text variable with underscores replaced by spaces.
    """
